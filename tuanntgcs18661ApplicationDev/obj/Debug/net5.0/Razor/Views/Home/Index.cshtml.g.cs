#pragma checksum "C:\Users\PHONGVU\Desktop\loccss\loccss\tuanntgcs18661ApplicationDev\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7e771ffe9aeaa3a55d073dc4422fa77a3a7f249c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7e771ffe9aeaa3a55d073dc4422fa77a3a7f249c", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\PHONGVU\Desktop\loccss\loccss\tuanntgcs18661ApplicationDev\Views\Home\Index.cshtml"
...
<div class=""banner-wrapper bg-light"">
    <div id=""index_banner"" class=""banner-vertical-center-index container-fluid pt-5"">
        ...
        <div id=""carouselExampleIndicators"" class=""carousel slide"" data-bs-ride=""carousel"">
                ...
                <div class=""carousel-item active"">
                    ...
                    <div class=""py-5 row d-flex align-items-center"">
                        <div class=""banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5"">
                            <h1 class=""banner-heading h1 text-secondary display-3 mb-0 pb-5 mx-0 px-0 light-300 ");
            WriteLiteral(@"typo-space-line"">
                                Welcome to <strong>Universitys</strong> of
                                <br>Greenwich
                            </h1>
                            <p class=""banner-body text-muted py-3 mx-0 px-0"">
                                
                            </p>
                            <a class=""banner-button btn rounded-pill btn-outline-primary btn-lg px-4"" href=""https://greenwich.edu.vn/en/english/"" role=""button"">Get Started</a>
                        </div>
                    </div>
                    ...
                    <div class=""py-5 row d-flex align-items-center"">
                        <div class=""banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5"">
                            <h1 class=""banner-heading h1 text-secondary display-3 mb-0 pb-3 mx-0 px-0 light-300"">
                                Admission announcement for the academic year 2021
              ");
            WriteLiteral(@"              </h1>
                            <p class=""banner-body text-muted py-3"">
                                As an alliance with FPT University, the University of Greenwich in Vietnam was established in 2009. By 2020, it has had a global network of more than 14.000 students and alumni from over 12 countries in the world.
                            </p>
                            <a class=""banner-button btn rounded-pill btn-outline-primary btn-lg px-4"" href=""https://greenwich.edu.vn/en/english/"" role=""button"">Get Started</a>
                        </div>
                    </div>
            ...
            <a class=""carousel-control-next text-decoration-none"" href=""#carouselExampleIndicator");
            WriteLiteral(@"s"" role=""button"" data-bs-slide=""next"">
...
<section class=""service-wrapper py-3"">
    <div class=""container-fluid pb-3"">
        <div class=""row"">
            ...
            <div class=""service-heading col-10 col-lg-9 text-start float-end light-300"">
                <h2 class=""h3 pb-4 typo-space-line"">Scholarships</h2>
            </div>
        </div>
        <p class=""service-footer col-10 offset-2 col-lg-9 offset-lg-3 text-start pb-3 text-muted px-2"">
            To financially support students on the path of pursuing their dreams, University of Gree");
            WriteLiteral(@"nwich is offering students with outstanding achievements with hundreds of scholarships with a total value of up to 86 billion VND in the academic year 2021.
        </p>
    </div>
    ...
    <div class=""service-tag py-5 bg-secondary"">
      ...
      ");
            WriteLiteral(@"          <li class=""nav-item mx-lg-4"">
...
<section class=""container overflow-hidden py-5"">
    <div class=""row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-3 pb-3 projects"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project branding"">
            <a href=""#"" class=""service-work card border-0 text-");
            WriteLiteral(@"white shadow-sm overflow-hidden mx-5 m-sm-0"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                ...
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left");
...
<section class=""py-5 mb-5"">
    <div class=""container"">
        <div class=""recent");
            WriteLiteral(@"-work-header row text-center pb-5"">
        ...
        <div class=""row gy-5 g-lg-5 mb-4"">
            ...
            <!-- Start Recent Work -->
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card bor");
            WriteLiteral(@"der-0 shadow-lg overflow-hidden"">
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    ...
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb");
            WriteLiteral(@"-3 ml-3 text-dark"">
